...
/**
 * El sitio publico es de solo lectura y anonimo. La escritura queda reservada
 * al panel de administracion, que se protege en la rama de autenticacion.
 */
@Configuration
@EnableWebSecurity
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(HttpMethod.GET, "/api/categories/**", "/api/products/**",
                                "/api/finishings/**", "/api/search").permitAll()
